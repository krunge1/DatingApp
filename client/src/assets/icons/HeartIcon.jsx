// icon:chat-heart | Bootstrap https://icons.getbootstrap.com/ | Bootstrap
import * as React from "react";

function IconChatHeart(props) {
    return (
        <svg
            fill="currentColor"
            viewBox="0 0 16 16"
